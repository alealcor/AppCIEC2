...
public class MapasFragment extends Fragment implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    public String readJSONFromAsset() {
        String json = null;
        try {
            InputStream is = this.getResources().getAssets().open("gye_barrios.geojson");
